...
<pre><code class="lang-js">d3.json(<span class="hljs-string">'https://d3fc.io/examples/bubble/data.json'</span>, <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">error, data</span>) </span>{
    ...
    <span class="hljs-keyword">var</span> regions = d3.set(data.map(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">d</span>) </span>{ <span class="hljs-keyword">return</span> d.region; }));
    ...
    <span class="hljs-keyword">var</span> size = d3.scale.linear()
    ...
    <span class="hljs-keyword">var</span> pointSeries = fc.series.point()
        ...
        .size(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">d</span>) </span>{ <span class="hljs-keyword">return</span> size(d.population); })
        .decorate(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">sel</span>) </span>{
            sel.enter()
                .attr(<span class="hljs-string">'fill'</span>, <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">d</span>) </span>{ <span class="hljs-keyword">return</span> color(d.region); });
        });
    ...
    <span class="hljs-keyword">var</span> chart = fc.chart.cartesian(
        ...
        .margin({left: <span class="hljs-number">40</span>, bottom: <span class="hljs-number">40</span>, top: <span class="hljs-number">30</span>})
        .plotArea(pointSeries)
