...
<p>This example demonstrates how to a simple cartesian chart with a line and an area series. The chart is constructed from the following components:</p>
<ul>
<li>A <a href="/components/chart/cartesian.html">cartesian chart</a>, with linear scales for x and y, is used to render the plot area, axes and labels. The <code>xBaseline</code> property is used to render the legend on the <code>y = 0</code> line.</li>
<li>The data is rendered via a <a href="/components/series/line.html">line series</a> and an <a href="/components/series/area.html">area series</a>, these are combined into a single series using the <a href="/components/series/multi.html">multi series</a> component.</li>
<li>A <a href="/components/annotation/gridlines.html">gridlines component</a> is also added to the multi series.</li>
<li>The <a href="/components/util/extent.html">extent</a> utility function is used to calculate the domain for the x and y scale, with padding applied to the y scale.</li>
</ul>
...
<span class="hljs-keyword">var</span> data = d3.range(<span class="hljs-number">50</span>).map(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">d</span>) </span>{
    <span class="hljs-keyword">return</span> {
        x: d / <span class="hljs-number">4</span>,
        y: <span class="hljs-built_in">Math</span>.sin(d / <span class="hljs-number">4</span>),
        z: <span class="hljs-built_in">Math</span>.cos(d / <span class="hljs-number">4</span>) * <span class="hljs-number">0.7</span>
    };
});
...
<span class="hljs-keyword">var</span> chart = fc.chart.cartesian(
              d3.scale.linear(),
              d3.scale.linear())
          .yDomain(fc.util.extent().pad(<span class="hljs-number">0.2</span>).fields([<span class="hljs-string">'y'</span>, <span class="hljs-string">'z'</span>])(data))
          .yLabel(<span class="hljs-string">'Sine / Cosine'</span>)
          .yNice()
          .yOrient(<span class="hljs-string">'left'</span>)
          .xDomain(fc.util.extent().fields(<span class="hljs-string">'x'</span>)(data))
          .xLabel(<span class="hljs-string">'Value'</span>)
          .xBaseline(<span class="hljs-number">0</span>)
          .chartLabel(<span class="hljs-string">'Sine/Cosine Line/Area Chart'</span>)
          .margin({left: <span class="hljs-number">50</span>, bottom: <span class="hljs-number">20</span>, top: <span class="hljs-number">30</span>});

<span class="hljs-comment">// create a pair of series and some gridlines</span>
<span class="hljs-keyword">var</span> sinLine = fc.series.line()
...
<span class="hljs-keyword">var</span> cosLine = fc.series.area()
  .xValue(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">d</span>) </span>{ <span class="hljs-keyword">return</span> d.x; })
  .yValue(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">d</span>) </span>{ <span class="hljs-keyword">return</span> d.z; });
