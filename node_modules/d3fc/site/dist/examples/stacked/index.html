...
<pre><code class="lang-js">d3.csv(<span class="hljs-string">'https://d3fc.io/examples/stacked/data.csv'</span>, <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(error, data)</span> </span>{
    ...
    <span class="hljs-keyword">var</span> color = d3.scale.category20()
    ...
    <span class="hljs-keyword">var</span> legend = d3.legend.color()
    ...
    <span class="hljs-keyword">var</span> stack = fc.series.stacked.bar()
        ...
        .decorate(<span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(sel, _, index)</span> </span>{
            sel.enter().attr(<span class="hljs-string">'fill'</span>, color(series[index].key));
        });
    ...
    <span class="hljs-keyword">var</span> chart = fc.chart.cartesian(
            ...
            .margin({left: <span class="hljs-number">100</span>, bottom: <span class="hljs-number">40</span>, right: <span class="hljs-number">10</span>, top: <span class="hljs-number">30</span>})
            .plotArea(stack)
            .decorate(<span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(selection)</span> </span>{
                ...
                selection.enter()
                    ...
                    .layout({
                        ...
                        width: <span class="hljs-number">358</span>,
                ...
                selection.select(<span class="hljs-string">'g.legend-container'</span>)
                  .style(<span class="hljs-string">'display'</span>, <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">()</span> </span>{
                      ...
                      <span class="hljs-keyword">var</span> availableWidth = selection.select(<span class="hljs-string">'.plot-area'</span>).layout(<span class="hljs-string">'width'</span>);
