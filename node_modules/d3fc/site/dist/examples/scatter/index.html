...
<pre><code class="lang-js">d3.tsv(<span class="hljs-string">'https://d3fc.io/examples/scatter/data.tsv'</span>, <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">error, data</span>) </span>{
    ...
    <span class="hljs-keyword">var</span> species = d3.set(data.map(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">d</span>) </span>{ <span class="hljs-keyword">return</span> d.species; }));
    <span class="hljs-keyword">var</span> color = d3.scale.category10()
        .domain(species.values());

    <span class="hljs-keyword">var</span> legend = d3.legend.color().scale(color);
    ...
    <span class="hljs-keyword">var</span> pointSeries = fc.series.point()
        ...
        .decorate(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">sel</span>) </span>{
            sel.enter()
                .attr(<span class="hljs-string">'fill'</span>, <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">d</span>) </span>{ <span class="hljs-keyword">return</span> color(d.species); });
        });
    ...
    <span class="hljs-keyword">var</span> chart = fc.chart.cartesian(
        ...
        .margin({left: <span class="hljs-number">50</span>, bottom: <span class="hljs-number">50</span>})
        .plotArea(pointSeries)
