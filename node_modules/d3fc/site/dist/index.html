...
<div id="quick-start" class="quick-start">
  <div class="container">
    ...
    <div class="row">
      <div class="col-sm-3 ">
        <h3>Install</h3>
        <p>A complete set of instructions for obtaining d3fc and its dependencies via npm are available in the <a href="components/introduction/getting-started.html">Getting Started Guide</a>.</p>
      </div>
      <div class="col-sm-3 ">
        <h3>Learn</h3>
