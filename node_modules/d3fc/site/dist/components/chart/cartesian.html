...
<html lang="en">
  <head>
    ...
    <link rel="canonical" href="https://d3fc.io/components/chart/cartesian.html" />
  </head>
  <body>
    <div class="content">
  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-xs-12">
      <h1>
        Cartesian
        <a href="https://github.com/ScottLogic/d3fc/blob/master/src/chart/cartesian.js">View source on GitHub</a>
      </h1>
...
<span class="hljs-keyword">var</span> data = d3.range(<span class="hljs-number">50</span>).map(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">d</span>) </span>{
    <span class="hljs-keyword">return</span> {
        x: d / <span class="hljs-number">3</span>,
        y: <span class="hljs-built_in">Math</span>.sin(d / <span class="hljs-number">3</span>)
    };
});

<span class="hljs-comment">// create a chart with two linear axes</span>
<span class="hljs-keyword">var</span> chart = fc.chart.cartesian(
        ...
        .yDomain(fc.util.extent().fields(<span class="hljs-string">'y'</span>)(data));

<span class="hljs-comment">// create a series and associate it with the plot area</span>
<span class="hljs-keyword">var</span> line = fc.series.line()
...
<p>A number of the more <a href="/examples">complex examples</a> use the cartesian chart as the basic &#39;boiler plate&#39; for constructing a chart.</p>

      
      <nav class="visible-xs-block">
        <ul class="pager">
            <li class="previous"><a href="/components/introduction/component-design.html"><span aria-hidden="true">&larr;</span> Component Design</a></li>
            <li class="next"><a href="/components/chart/legend.html">Legend <span aria-hidden="true">&rarr;</span></a></li>
        </ul>
      </nav>
    </div>
