...
<html lang="en">
  <head>
    ...
    <link rel="canonical" href="https://d3fc.io/components/chart/sparkline.html" />
  </head>
  <body>
    <div class="content">
...
<pre><code class="lang-html">&lt;p style=<span class="hljs-string">"padding: 10px"</span>&gt;The FTSE <span class="hljs-number">100</span> rose <span class="hljs-number">53.96</span> points, <span class="hljs-keyword">or</span> <span class="hljs-number">0.8</span>%, <span class="hljs-keyword">to</span> <span class="hljs-number">6</span>,<span class="hljs-number">574.94</span> &lt;span <span class="hljs-keyword">class</span>=<span class="hljs-comment">'sparkline'&gt;<span class="hljs-doctag">&lt;/span&gt;</span>.</span>
Elsewhere <span class="hljs-keyword">in</span> Europe, Germany<span class="hljs-comment">'s Dax index was up 1.1% <span class="hljs-doctag">&lt;span class='sparkline'&gt;</span><span class="hljs-doctag">&lt;/span&gt;</span>, while in France,</span>
the Cac <span class="hljs-number">40</span> index climbed <span class="hljs-number">1</span>% &lt;span <span class="hljs-keyword">class</span>=<span class="hljs-comment">'sparkline'&gt;<span class="hljs-doctag">&lt;/span&gt;</span>. On the currency markets, the euro fell 0.3%</span>
against the dollar <span class="hljs-keyword">to</span> $<span class="hljs-number">1.1111</span> &lt;span <span class="hljs-keyword">class</span>=<span class="hljs-comment">'sparkline'&gt;<span class="hljs-doctag">&lt;/span&gt;</span>. The pound rose 0.2% against the euro</span>
<span class="hljs-keyword">to</span> €<span class="hljs-number">1.4138</span> &lt;span <span class="hljs-keyword">class</span>=<span class="hljs-comment">'sparkline'&gt;<span class="hljs-doctag">&lt;/span&gt;</span> and was flat against the dollar at $1.5711 <span class="hljs-doctag">&lt;span class='sparkline'&gt;</span><span class="hljs-doctag">&lt;/span&gt;</span>.<span class="hljs-doctag">&lt;/p&gt;</span></span>
</code></pre>
<p>The following code selects all of these elements, using this component to construct a sparkline for each one:</p>
<pre><code class="lang-js">d3.selectAll(<span class="hljs-string">'.sparkline'</span>)
    .<span class="hljs-keyword">each</span>(<span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">()</span> </span>{
        <span class="hljs-keyword">var</span> sparkline = d3.select(<span class="hljs-keyword">this</span>);

        <span class="hljs-comment">// typically at this point you would fetch or look-up the</span>
        <span class="hljs-comment">// data for the specific sparkline - here we use dummy data instead</span>

        <span class="hljs-comment">// var stock = sparkline.attr('data-ticker');</span>
        <span class="hljs-keyword">var</span> data = fc.data.random.financial()(<span class="hljs-number">50</span>);

        <span class="hljs-keyword">var</span> chart = fc.chart.sparkline()
            .xDomain(fc.util.extent().fields(<span class="hljs-string">'date'</span>)(data))
            .yDomain(fc.util.extent().fields(<span class="hljs-string">'low'</span>)(data))
...
d3.selectAll('.sparkline')
    .each(function() {
      ...
      <nav class="visible-xs-block">
        <ul class="pager">
            <li class="previous"><a href="/components/chart/small-multiples.html"><span aria-hidden="true">&larr;</span> Small Multiples</a></li>
            <li class="next"><a href="/components/chart/tooltip.html">Tooltip <span aria-hidden="true">&rarr;</span></a></li>
        </ul>
      </nav>
    </div>
