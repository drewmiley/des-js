...
<html lang="en">
  <head>
    ...
    <link rel="canonical" href="https://d3fc.io/components/series/grouped-bar.html" />
  </head>
  <body>
    <div class="content">
  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-xs-12">
      <h1>
        Grouped Bar Series
        <a href="https://github.com/ScottLogic/d3fc/blob/master/src/series/groupedBar.js">View source on GitHub</a>
      </h1>
      <p>The grouped bar component renders multiple series of data in a grouped / clustered form.</p>
...
<span class="hljs-keyword">var</span> container = d3.select(<span class="hljs-string">'#grouped-bar'</span>)
...
<span class="hljs-keyword">var</span> data = [{
    <span class="hljs-string">'State'</span>: <span class="hljs-string">'AL'</span>,
    <span class="hljs-string">'Under 5 Years'</span>: <span class="hljs-string">'310'</span>,
    <span class="hljs-string">'5 to 13 Years'</span>: <span class="hljs-string">'552'</span>,
    <span class="hljs-string">'14 to 17 Years'</span>: <span class="hljs-string">'259'</span>,
    <span class="hljs-string">'18 to 24 Years'</span>: <span class="hljs-string">'450'</span>,
    <span class="hljs-string">'25 to 44 Years'</span>: <span class="hljs-string">'1215'</span>,
    <span class="hljs-string">'45 to 64 Years'</span>: <span class="hljs-string">'641'</span>
}, {
    <span class="hljs-string">'State'</span>: <span class="hljs-string">'AK'</span>,
    <span class="hljs-string">'Under 5 Years'</span>: <span class="hljs-string">'52'</span>,
    <span class="hljs-string">'5 to 13 Years'</span>: <span class="hljs-string">'85'</span>,
    <span class="hljs-string">'14 to 17 Years'</span>: <span class="hljs-string">'42'</span>,
    <span class="hljs-string">'18 to 24 Years'</span>: <span class="hljs-string">'74'</span>,
    <span class="hljs-string">'25 to 44 Years'</span>: <span class="hljs-string">'183'</span>,
    <span class="hljs-string">'45 to 64 Years'</span>: <span class="hljs-string">'50'</span>
}, {
    <span class="hljs-string">'State'</span>: <span class="hljs-string">'AZ'</span>,
    <span class="hljs-string">'Under 5 Years'</span>: <span class="hljs-string">'515'</span>,
    <span class="hljs-string">'5 to 13 Years'</span>: <span class="hljs-string">'828'</span>,
    <span class="hljs-string">'14 to 17 Years'</span>: <span class="hljs-string">'362'</span>,
    <span class="hljs-string">'18 to 24 Years'</span>: <span class="hljs-string">'601'</span>,
    <span class="hljs-string">'25 to 44 Years'</span>: <span class="hljs-string">'1804'</span>,
    <span class="hljs-string">'45 to 64 Years'</span>: <span class="hljs-string">'1523'</span>
}, {
    <span class="hljs-string">'State'</span>: <span class="hljs-string">'AR'</span>,
    <span class="hljs-string">'Under 5 Years'</span>: <span class="hljs-string">'202'</span>,
    <span class="hljs-string">'5 to 13 Years'</span>: <span class="hljs-string">'343'</span>,
    <span class="hljs-string">'14 to 17 Years'</span>: <span class="hljs-string">'157'</span>,
    <span class="hljs-string">'18 to 24 Years'</span>: <span class="hljs-string">'264'</span>,
    <span class="hljs-string">'25 to 44 Years'</span>: <span class="hljs-string">'754'</span>,
    <span class="hljs-string">'45 to 64 Years'</span>: <span class="hljs-string">'727'</span>
}];
...
<span class="hljs-keyword">var</span> x = d3.scale.ordinal()
    .domain(data.map(<span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(d)</span> </span>{ <span class="hljs-keyword">return</span> d.State; }))
...
<span class="hljs-keyword">var</span> yExtent = fc.util.extent()
    .fields(<span class="hljs-string">'y'</span>)
    .<span class="hljs-keyword">include</span>(<span class="hljs-number">0</span>);

<span class="hljs-keyword">var</span> y = d3.scale.linear()
    .domain(yExtent(series.map(<span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(d)</span> </span>{ <span class="hljs-keyword">return</span> d.values; })))
    .range([height, <span class="hljs-number">0</span>]);

<span class="hljs-comment">// create the grouped bar series</span>
<span class="hljs-keyword">var</span> groupedBar = fc.series.groupedBar()
    .xScale(x)
    .yScale(y)
    .xValue(<span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(d)</span> </span>{ <span class="hljs-keyword">return</span> d.x; })
    .yValue(<span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(d)</span> </span>{ <span class="hljs-keyword">return</span> d.y; });
...
<div class="codepen-link">
  <form action="https://codepen.io/pen/define" method="POST" target="_blank">
    <input type="text" name="data" hidden="true"
      value='{
        "html":"&lt;div id&#x3D;\&quot;grouped-bar\&quot; class&#x3D;\&quot;chart\&quot;&gt;&lt;/div&gt;\n",
...
container.append('g')
    ...
    .call(groupedBar);
      ...
      <nav class="visible-xs-block">
        <ul class="pager">
            <li class="previous"><a href="/components/series/errorBar.html"><span aria-hidden="true">&larr;</span> Error Bar Series</a></li>
            <li class="next"><a href="/components/series/line.html">Line Series <span aria-hidden="true">&rarr;</span></a></li>
        </ul>
      </nav>
    </div>
