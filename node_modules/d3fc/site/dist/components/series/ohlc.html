...
<html lang="en">
  <head>
    ...
    <link rel="canonical" href="https://d3fc.io/components/series/ohlc.html" />
  </head>
  <body>
    <div class="content">
  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-xs-12">
      <h1>
        OHLC Series
        <a href="https://github.com/ScottLogic/d3fc/blob/master/src/series/ohlc.js">View source on GitHub</a>
      </h1>
      <p>An <a href="http://en.wikipedia.org/wiki/Open-high-low-close_chart">open-high-low-close (OHLC) series</a> renders the open, high, low and close values for each bucketed time period:</p>
<pre><code class="lang-js"><span class="hljs-keyword">var</span> candlestick = fc.series.ohlc()
    .xScale(xScale)
    .yScale(yScale);
...
<div class="codepen-link">
  <form action="https://codepen.io/pen/define" method="POST" target="_blank">
    <input type="text" name="data" hidden="true"
      value='{
        "html":"&lt;div id&#x3D;\&quot;ohlc\&quot; class&#x3D;\&quot;chart\&quot;&gt;&lt;/div&gt;\n",
...
<p>The OHLC series shares the same configuration options as the <a href="#candlestick">candlestick series</a>.</p>

      
      <nav class="visible-xs-block">
        <ul class="pager">
            <li class="previous"><a href="/components/series/multi.html"><span aria-hidden="true">&larr;</span> Multi Series</a></li>
            <li class="next"><a href="/components/series/point.html">Point Series <span aria-hidden="true">&rarr;</span></a></li>
        </ul>
      </nav>
    </div>
