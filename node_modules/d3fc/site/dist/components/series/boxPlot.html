...
<html lang="en">
  <head>
    ...
    <link rel="canonical" href="https://d3fc.io/components/series/boxPlot.html" />
  </head>
  <body>
    <div class="content">
  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-xs-12">
      <h1>
        Box Plot Series
        <a href="https://github.com/ScottLogic/d3fc/blob/master/src/series/boxPlot.js">View source on GitHub</a>
      </h1>
      <p>A <a href="https://en.wikipedia.org/wiki/Box_plot">box plot series</a> is a convenient way of graphically depicting groups of
numerical data through their quartiles. Boxes can be renderer vertically or horizontally based on the value of the <code>orient</code> property.</p>
<p>The upper and lower end of each box are defined by the <code>upperQuartile</code> and <code>lowerQuartile</code> properties.
The upper and lower whisker of each box are defined by the <code>high</code> and <code>low</code> properties.
The line in the box is defined by the <code>median</code> property.
The <code>barWidth</code> property specifies the width of the box and <code>cap</code> defines the width of the whisker end caps as a fraction of the <code>barWidth</code>.</p>
<p>The following example generates a random box plot around each datapoint:</p>
<pre><code class="lang-js">//<span class="hljs-type">Generating</span> the boxPlot information <span class="hljs-keyword">for</span> the data
<span class="hljs-keyword">var</span> dataGenerator = fc.data.random.walk()
  .steps(<span class="hljs-number">10</span>);
<span class="hljs-keyword">var</span> data = dataGenerator()
    .map(function(datum, index) {
        <span class="hljs-keyword">var</span> <span class="hljs-literal">result</span> = {
            value: index
        };
        <span class="hljs-literal">result</span>.median = <span class="hljs-number">10</span> + <span class="hljs-type">Math</span>.random();
        <span class="hljs-literal">result</span>.upperQuartile = <span class="hljs-literal">result</span>.median + <span class="hljs-type">Math</span>.random();
        <span class="hljs-literal">result</span>.lowerQuartile = <span class="hljs-literal">result</span>.median - <span class="hljs-type">Math</span>.random();
        <span class="hljs-literal">result</span>.high = <span class="hljs-literal">result</span>.upperQuartile + <span class="hljs-type">Math</span>.random();
        <span class="hljs-literal">result</span>.low = <span class="hljs-literal">result</span>.lowerQuartile - <span class="hljs-type">Math</span>.random();
...
<span class="hljs-keyword">var</span> xScale = d3.scale.linear()
    .domain(fc.util.extent().pad(<span class="hljs-number">0</span>.<span class="hljs-number">1</span>).fields('value')(data))
...
<span class="hljs-keyword">var</span> boxPlot = fc.series.boxPlot()
    .xScale(xScale)
    .yScale(yScale)
    .value(function(d) { <span class="hljs-keyword">return</span> d.value; })
    .median(function(d) { <span class="hljs-keyword">return</span> d.median; })
    .upperQuartile(function(d) { <span class="hljs-keyword">return</span> d.upperQuartile; })
    .lowerQuartile(function(d) { <span class="hljs-keyword">return</span> d.lowerQuartile; })
    .high(function(d) { <span class="hljs-keyword">return</span> d.high; })
    .low(function(d) { <span class="hljs-keyword">return</span> d.low; });
...
<div class="codepen-link">
  <form action="https://codepen.io/pen/define" method="POST" target="_blank">
    <input type="text" name="data" hidden="true"
      value='{
        "html":"&lt;div id&#x3D;\&quot;boxplot\&quot; class&#x3D;\&quot;chart\&quot;&gt;&lt;/div&gt;\n",
...
//END
      ...
      <nav class="visible-xs-block">
        <ul class="pager">
            <li class="previous"><a href="/components/series/bar.html"><span aria-hidden="true">&larr;</span> Bar Series</a></li>
            <li class="next"><a href="/components/series/candlestick.html">Candlestick Series <span aria-hidden="true">&rarr;</span></a></li>
        </ul>
      </nav>
    </div>
