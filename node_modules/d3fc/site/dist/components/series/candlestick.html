...
<html lang="en">
  <head>
    ...
    <title>Candlestick Series</title>
    ...
    <link rel="canonical" href="https://d3fc.io/components/series/candlestick.html" />
  </head>
  <body>
    <div class="content">
  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-xs-12">
      <h1>
        Candlestick Series
        <a href="https://github.com/ScottLogic/d3fc/blob/master/src/series/candlestick.js">View source on GitHub</a>
      </h1>
      <p>A <a href="http://en.wikipedia.org/wiki/Candlestick_chart">candlestick series</a> renders the open, high, low and close values for each bucketed time period:</p>
<pre><code class="lang-js"><span class="hljs-keyword">var</span> candlestick = fc.series.candlestick()
    .xScale(xScale)
    .yScale(yScale);
...
<div class="codepen-link">
  <form action="https://codepen.io/pen/define" method="POST" target="_blank">
    <input type="text" name="data" hidden="true"
      value='{
        "html":"&lt;div id&#x3D;\&quot;candlestick\&quot; class&#x3D;\&quot;chart\&quot;&gt;&lt;/div&gt;\n",
...
<p>You can configure how the series obtains the high, low, open close values via the <code>yOpenValue</code>, <code>yHighValue</code>, <code>yLowValue</code> and <code>yCloseValue</code> properties. You can configure the width of each candlestick via the <code>barWidth</code> property, and also modify how they are rendered via the <code>decorate</code> property.</p>

      
      <nav class="visible-xs-block">
        <ul class="pager">
            <li class="previous"><a href="/components/series/boxPlot.html"><span aria-hidden="true">&larr;</span> Box Plot Series</a></li>
            <li class="next"><a href="/components/series/cycle.html">Cycle Series <span aria-hidden="true">&rarr;</span></a></li>
        </ul>
      </nav>
    </div>
