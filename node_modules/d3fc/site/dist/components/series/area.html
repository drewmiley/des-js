...
<html lang="en">
  <head>
    ...
    <link rel="canonical" href="https://d3fc.io/components/series/area.html" />
  </head>
  <body>
    <div class="content">
  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-xs-12">
      <h1>
        Area Series
        <a href="https://github.com/ScottLogic/d3fc/blob/master/src/series/area.js">View source on GitHub</a>
      </h1>
      <p>The area series renders the given data as a filled area, constructed from an SVG <code>path</code>:</p>
...
var xScale = d3.<span class="hljs-built_in">scale</span>.linear()
    .domain(fc.util.extent().fields(<span class="hljs-string">'x'</span>)(<span class="hljs-keyword">data</span>))
...
var yScale = d3.<span class="hljs-built_in">scale</span>.linear()
    .domain(fc.util.extent().fields(<span class="hljs-string">'y'</span>)(<span class="hljs-keyword">data</span>))
...
container.append(<span class="hljs-string">'g'</span>)
    ...
    .<span class="hljs-keyword">call</span>(area);
</code></pre>
...
<div class="codepen-link">
  <form action="https://codepen.io/pen/define" method="POST" target="_blank">
    <input type="text" name="data" hidden="true"
      value='{
        "html":"&lt;div id&#x3D;\&quot;area\&quot; class&#x3D;\&quot;chart\&quot;&gt;&lt;/div&gt;\n",
...
<p>This series has the same <code>xValue</code>, <code>yValue</code> and <code>decorate</code> properties as the <a href="#point">point series</a>. You can also render this series as a band by specifying <code>y0Value</code> and <code>y1Value</code> properties:</p>
<pre><code class="lang-js">var dataGenerator = fc.<span class="hljs-keyword">data</span>.random.walk();
var <span class="hljs-keyword">data</span> = dataGenerator(<span class="hljs-number">100</span>).map(<span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(datum, index)</span></span> {
    <span class="hljs-keyword">return</span> {
        x: <span class="hljs-built_in">index</span>,
        y0: datum,
        y1: datum + Math.random() * <span class="hljs-number">10</span>
    };
});
...
var yScale = d3.<span class="hljs-built_in">scale</span>.linear()
    .domain(fc.util.extent().fields([<span class="hljs-string">'y0'</span>, <span class="hljs-string">'y1'</span>])(<span class="hljs-keyword">data</span>))
    .<span class="hljs-built_in">range</span>([height, <span class="hljs-number">0</span>]);

var area = fc.series.area()
    .xValue(<span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(d)</span></span> { <span class="hljs-keyword">return</span> d.x; })
    .y0Value(<span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(d)</span></span> { <span class="hljs-keyword">return</span> d.y0; })
    .y1Value(<span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(d)</span></span> { <span class="hljs-keyword">return</span> d.y1; })
    .xScale(xScale)
    .yScale(yScale);
...
<div class="codepen-link">
  <form action="https://codepen.io/pen/define" method="POST" target="_blank">
    <input type="text" name="data" hidden="true"
      value='{
        "html":"&lt;div id&#x3D;\&quot;band\&quot; class&#x3D;\&quot;chart\&quot;&gt;&lt;/div&gt;\n",
...
//END
      ...
      <nav class="visible-xs-block">
        <ul class="pager">
            <li class="previous"><a href="/components/chart/tooltip.html"><span aria-hidden="true">&larr;</span> Tooltip</a></li>
            <li class="next"><a href="/components/series/bar.html">Bar Series <span aria-hidden="true">&rarr;</span></a></li>
        </ul>
      </nav>
    </div>
