...
<html lang="en">
  <head>
    ...
    <link rel="canonical" href="https://d3fc.io/components/series/line.html" />
  </head>
  <body>
    <div class="content">
  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-xs-12">
      <h1>
        Line Series
        <a href="https://github.com/ScottLogic/d3fc/blob/master/src/series/line.js">View source on GitHub</a>
      </h1>
      <p>The line series renders the given data as a line, constructed from an SVG <code>path</code>:</p>
<pre><code class="lang-js"><span class="hljs-keyword">var</span> <span class="hljs-keyword">line</span> = fc.series.<span class="hljs-keyword">line</span>()
    .xValue(function(<span class="hljs-keyword">d</span>) { <span class="hljs-keyword">return</span> <span class="hljs-keyword">d</span>.x; })
    .yValue(function(<span class="hljs-keyword">d</span>) { <span class="hljs-keyword">return</span> <span class="hljs-keyword">d</span>.y; })
    .xScale(xScale)
    .yScale(yScale);

container.<span class="hljs-keyword">append</span>('<span class="hljs-keyword">g</span>')
    .datum(data)
    .call(<span class="hljs-keyword">line</span>);
</code></pre>
...
<div class="codepen-link">
  <form action="https://codepen.io/pen/define" method="POST" target="_blank">
    <input type="text" name="data" hidden="true"
      value='{
        "html":"&lt;div id&#x3D;\&quot;line\&quot; class&#x3D;\&quot;chart\&quot;&gt;&lt;/div&gt;\n",
...
<p>This series has the same properties for specifying the x and y value accessors, and decorate as the <a href="#point">point series</a>.</p>
<p>The line series component also exposes the <code>interpolate</code> and <code>tension</code> properties from the d3 line shape that it uses for rendering. For more information about the interpolation modes refer to the official <a href="https://github.com/mbostock/d3/wiki/SVG-Shapes#line">D3 Line Documentation</a>.</p>
<p>The following example demonstrates how to render a step series via the <code>step</code> interpolation mode:</p>
<pre><code class="lang-js"><span class="hljs-keyword">var</span> <span class="hljs-keyword">line</span> = fc.series.<span class="hljs-keyword">line</span>()
    .interpolate('step')
    .xValue(function(<span class="hljs-keyword">d</span>) { <span class="hljs-keyword">return</span> <span class="hljs-keyword">d</span>.x; })
    .yValue(function(<span class="hljs-keyword">d</span>) { <span class="hljs-keyword">return</span> <span class="hljs-keyword">d</span>.y; })
...
<div class="codepen-link">
  <form action="https://codepen.io/pen/define" method="POST" target="_blank">
    <input type="text" name="data" hidden="true"
      value='{
        "html":"&lt;div id&#x3D;\&quot;step\&quot; class&#x3D;\&quot;chart\&quot;&gt;&lt;/div&gt;\n",
...
//END
      ...
      <nav class="visible-xs-block">
        <ul class="pager">
            <li class="previous"><a href="/components/series/grouped-bar.html"><span aria-hidden="true">&larr;</span> Grouped Bar Series</a></li>
            <li class="next"><a href="/components/series/multi.html">Multi Series <span aria-hidden="true">&rarr;</span></a></li>
        </ul>
      </nav>
    </div>
