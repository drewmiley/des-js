...
<html lang="en">
  <head>
    ...
    <link rel="canonical" href="https://d3fc.io/components/series/stacked.html" />
  </head>
  <body>
    <div class="content">
...
<pre><code class="lang-js"><span class="hljs-keyword">var</span> data = [
   ...
   {<span class="hljs-string">'State'</span>: <span class="hljs-string">'AR'</span>, <span class="hljs-string">'Under 5 Years'</span>: <span class="hljs-string">'202'</span>, <span class="hljs-string">'5 to 13 Years'</span>: <span class="hljs-string">'343'</span>, <span class="hljs-string">'14 to 17 Years'</span>: <span class="hljs-string">'157'</span>, <span class="hljs-string">'18 to 24 Years'</span>: <span class="hljs-string">'264'</span>, <span class="hljs-string">'25 to 44 Years'</span>: <span class="hljs-string">'754'</span>, <span class="hljs-string">'45 to 64 Years'</span>: <span class="hljs-string">'727'</span>},
   {<span class="hljs-string">'State'</span>: <span class="hljs-string">'CO'</span>, <span class="hljs-string">'Under 5 Years'</span>: <span class="hljs-string">'358'</span>, <span class="hljs-string">'5 to 13 Years'</span>: <span class="hljs-string">'587'</span>, <span class="hljs-string">'14 to 17 Years'</span>: <span class="hljs-string">'261'</span>, <span class="hljs-string">'18 to 24 Years'</span>: <span class="hljs-string">'466'</span>, <span class="hljs-string">'25 to 44 Years'</span>: <span class="hljs-string">'1464'</span>, <span class="hljs-string">'45 to 64 Years'</span>: <span class="hljs-string">'1290'</span>},
   {<span class="hljs-string">'State'</span>: <span class="hljs-string">'CT'</span>, <span class="hljs-string">'Under 5 Years'</span>: <span class="hljs-string">'211'</span>, <span class="hljs-string">'5 to 13 Years'</span>: <span class="hljs-string">'403'</span>, <span class="hljs-string">'14 to 17 Years'</span>: <span class="hljs-string">'196'</span>, <span class="hljs-string">'18 to 24 Years'</span>: <span class="hljs-string">'325'</span>, <span class="hljs-string">'25 to 44 Years'</span>: <span class="hljs-string">'916'</span>, <span class="hljs-string">'45 to 64 Years'</span>: <span class="hljs-string">'968'</span>},
   {<span class="hljs-string">'State'</span>: <span class="hljs-string">'DE'</span>, <span class="hljs-string">'Under 5 Years'</span>: <span class="hljs-string">'59'</span>, <span class="hljs-string">'5 to 13 Years'</span>: <span class="hljs-string">'99'</span>, <span class="hljs-string">'14 to 17 Years'</span>: <span class="hljs-string">'47'</span>, <span class="hljs-string">'18 to 24 Years'</span>: <span class="hljs-string">'84'</span>, <span class="hljs-string">'25 to 44 Years'</span>: <span class="hljs-string">'230'</span>, <span class="hljs-string">'45 to 64 Years'</span>: <span class="hljs-string">'230'</span>}
];
...
<span class="hljs-keyword">var</span> series = stackLayout(spread(data));
...
<span class="hljs-keyword">var</span> yExtent = fc.util.extent()
    ...
    .fields(<span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(d)</span> </span>{ <span class="hljs-keyword">return</span> d.y + d.y0; });
...
<span class="hljs-comment">// create the stacked bar series (this could also be line or area)</span>
<span class="hljs-keyword">var</span> stack = fc.series.stacked.bar()
    .xScale(x)
    .yScale(y)
...
<div class="codepen-link">
  <form action="https://codepen.io/pen/define" method="POST" target="_blank">
    <input type="text" name="data" hidden="true"
      value='{
        "html":"&lt;div id&#x3D;\&quot;stacked\&quot; class&#x3D;\&quot;chart\&quot;&gt;&lt;/div&gt;\n",
...
//END
      ...
      <nav class="visible-xs-block">
        <ul class="pager">
            <li class="previous"><a href="/components/series/point.html"><span aria-hidden="true">&larr;</span> Point Series</a></li>
            <li class="next"><a href="/components/series/waterfall.html">Waterfall Series <span aria-hidden="true">&rarr;</span></a></li>
        </ul>
      </nav>
    </div>
