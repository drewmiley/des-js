...
<html lang="en">
  <head>
    ...
    <link rel="canonical" href="https://d3fc.io/components/series/bar.html" />
  </head>
  <body>
    <div class="content">
  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-xs-12">
      <h1>
        Bar Series
        <a href="https://github.com/ScottLogic/d3fc/blob/master/src/series/bar.js">View source on GitHub</a>
      </h1>
      <p>The bar series renders the given data as a series of vertical bars:</p>
<pre><code class="lang-js">var dataGenerator = fc.<span class="hljs-keyword">data</span>.random.walk();
var <span class="hljs-keyword">data</span> = dataGenerator(<span class="hljs-number">20</span>).map(<span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(datum, index)</span></span> {
...
container.append(<span class="hljs-string">'g'</span>)
    ...
    .<span class="hljs-keyword">call</span>(bar);
</code></pre>
...
<div class="codepen-link">
  <form action="https://codepen.io/pen/define" method="POST" target="_blank">
    <input type="text" name="data" hidden="true"
      value='{
        "html":"&lt;div id&#x3D;\&quot;bar\&quot; class&#x3D;\&quot;chart\&quot;&gt;&lt;/div&gt;\n",
...
<p>This series has the same <code>xValue</code>, <code>yValue</code> and <code>decorate</code> properties as the <a href="./point">point series</a>. You can also specify the width of the bars via the <code>barWidth</code> property.</p>
<p>The bar series supports horizonal display, using the <code>orient</code> property.</p>
<pre><code class="lang-js">var dataGenerator = fc.<span class="hljs-keyword">data</span>.random.walk();
var <span class="hljs-keyword">data</span> = dataGenerator(<span class="hljs-number">20</span>).map(<span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(datum, index)</span></span> {
    <span class="hljs-keyword">return</span> {
        // notice that x &amp; y have been transposed<span class="hljs-comment">!</span>
        x: datum,
        y: <span class="hljs-built_in">index</span>
    };
});
...
<div class="codepen-link">
  <form action="https://codepen.io/pen/define" method="POST" target="_blank">
    <input type="text" name="data" hidden="true"
      value='{
        "html":"&lt;div id&#x3D;\&quot;bar-horizontal\&quot; class&#x3D;\&quot;chart\&quot;&gt;&lt;/div&gt;\n",
...
<div id='bar-horizontal' class='chart'></div>
...
//END
      ...
      <nav class="visible-xs-block">
        <ul class="pager">
            <li class="previous"><a href="/components/series/area.html"><span aria-hidden="true">&larr;</span> Area Series</a></li>
            <li class="next"><a href="/components/series/boxPlot.html">Box Plot Series <span aria-hidden="true">&rarr;</span></a></li>
        </ul>
      </nav>
    </div>
