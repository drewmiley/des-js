...
<html lang="en">
  <head>
    ...
    <title>Largest Triangle 1 Bucket</title>
    ...
    <link rel="canonical" href="https://d3fc.io/components/sampler/largestTriangleOne.html" />
  </head>
  <body>
    <div class="content">
...
<p>The example below creates an array of 1,000 datapoints, sampling it using a bucket-size of 20. For simplicity of the example, the scale functions aren&#39;t called when accessing <code>x</code> or <code>y</code>.</p>
...
<span class="hljs-keyword">var</span> sampler = fc.data.sampler.largestTriangleOneBucket()
    .bucketSize(<span class="hljs-number">20</span>)
...
container.append('g')
    ...
    .call(originalLine);
      ...
      <nav class="visible-xs-block">
        <ul class="pager">
            <li class="previous"><a href="/components/series/waterfall.html"><span aria-hidden="true">&larr;</span> Waterfall Series</a></li>
            <li class="next"><a href="/components/sampler/largestTriangleThreeBucket.html">Largest Triangle 3 Buckets <span aria-hidden="true">&rarr;</span></a></li>
        </ul>
      </nav>
    </div>
