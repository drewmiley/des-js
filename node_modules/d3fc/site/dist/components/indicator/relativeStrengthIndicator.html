...
<html lang="en">
  <head>
    ...
    <link rel="canonical" href="https://d3fc.io/components/indicator/relativeStrengthIndicator.html" />
  </head>
  <body>
    <div class="content">
  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-xs-12">
      <h1>
        ...
        <a href="https://github.com/ScottLogic/d3fc/blob/master/src/indicator/algorithm/relativeStrengthIndex.js">View source on GitHub</a>
      </h1>
      <p>A <a href="http://en.wikipedia.org/wiki/Relative_strength_index">Relative Strength Index</a> is an indicator that plots the historical strength or weakness of a stock based on closing prices. It is typically plotted on a 14-day timeframe and is displayed next to overbought (70%) and oversold lines (30%) lines.</p>
<p>The RSI indicator is rendered on a percent scale:</p>
<pre><code class="lang-js"><span class="hljs-comment">// the RSI is output on a percentage scale, so requires a domain from 0 - 100</span>
<span class="hljs-keyword">var</span> yScale = d3.scale.linear()
      ...
      .<span class="hljs-keyword">range</span>([height, <span class="hljs-number">0</span>]);

<span class="hljs-comment">// Create and apply the RSI algorithm</span>
<span class="hljs-keyword">var</span> rsiAlgorithm = fc.indicator.algorithm.relativeStrengthIndex();
rsiAlgorithm(data);

<span class="hljs-comment">// Create the renderer</span>
<span class="hljs-keyword">var</span> rsi = fc.indicator.renderer.relativeStrengthIndex()
    .xScale(xScale)
    .yScale(yScale);
...
<div class="codepen-link">
  <form action="https://codepen.io/pen/define" method="POST" target="_blank">
    <input type="text" name="data" hidden="true"
      value='{
        "html":"&lt;div id&#x3D;\&quot;rsi\&quot; class&#x3D;\&quot;chart\&quot;&gt;&lt;/div&gt;\n",
...
<p>You can configure the number of datapoints that are included in the RSI via the <code>windowSize</code> property, you can also change how the close values are read via the <code>closeValue</code> property.</p>

      
      <nav class="visible-xs-block">
        <ul class="pager">
            <li class="previous"><a href="/components/indicator/movingAverage.html"><span aria-hidden="true">&larr;</span> Moving Average</a></li>
            <li class="next"><a href="/components/indicator/stochasticOscillator.html">Stochastic Oscillator <span aria-hidden="true">&rarr;</span></a></li>
        </ul>
      </nav>
    </div>
