...
<html lang="en">
  <head>
    ...
    <link rel="canonical" href="https://d3fc.io/components/indicator/exponentialMovingAverage.html" />
  </head>
  <body>
    <div class="content">
  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-xs-12">
      <h1>
        ...
        <a href="https://github.com/ScottLogic/d3fc/blob/master/src/indicator/algorithm/exponentialMovingAverage.js">View source on GitHub</a>
      </h1>
      <p>An <a href="https://en.wikipedia.org/?title=Moving_average#Exponential_moving_average">Exponential Moving Average</a> (EMA) is an indicator that smooths out fluctuations in data.</p>
<p>The example below creates a point series and an EMA:</p>
<pre><code class="lang-js"><span class="hljs-comment">// Create and apply the EMA</span>
<span class="hljs-keyword">var</span> movingAverage = fc.indicator.algorithm.exponentialMovingAverage();
movingAverage(data);

<span class="hljs-comment">// Create a line that renders the result</span>
<span class="hljs-keyword">var</span> <span class="hljs-keyword">ma</span> = fc.series.<span class="hljs-keyword">line</span>()
    .yValue(function(<span class="hljs-keyword">d</span>) { <span class="hljs-keyword">return</span> <span class="hljs-keyword">d</span>.exponentialMovingAverage; })
    .xScale(xScale)
    .yScale(yScale);
...
<p>You can configure the number of datapoints that are included in the moving average via the <code>windowSize</code> property, you can also change the object property that is averaged via the <code>yValue</code> property.</p>
      ...
      <nav class="visible-xs-block">
        <ul class="pager">
            <li class="previous"><a href="/components/indicator/envelope.html"><span aria-hidden="true">&larr;</span> Envelope</a></li>
            <li class="next"><a href="/components/indicator/forceIndex.html">Force Index <span aria-hidden="true">&rarr;</span></a></li>
        </ul>
      </nav>
    </div>
