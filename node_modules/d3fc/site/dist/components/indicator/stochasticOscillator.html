...
<html lang="en">
  <head>
    ...
    <link rel="canonical" href="https://d3fc.io/components/indicator/stochasticOscillator.html" />
  </head>
  <body>
    <div class="content">
  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-xs-12">
      <h1>
        ...
        <a href="https://github.com/ScottLogic/d3fc/blob/master/src/indicator/algorithm/stochasticOscillator.js">View source on GitHub</a>
      </h1>
      <p>A <a href="https://en.wikipedia.org/wiki/Stochastic_oscillator">Stochastic Oscillator</a> consists of two parts: %K and %D. %K relates the closing price to the full trading range over the specified window (5 data points by default). %D is the simple moving average of the %K values over a second window (3 data points by default).</p>
<p>The window lengths can be changed using the <code>kWindowSize</code> and <code>dWindowSize</code> properties. The calculation requires the High, Low and Close values of each data point. The object property used for these can be set via the <code>highValue</code>, <code>lowValue</code> and <code>closeValue</code> properties.</p>
<p>By default, the results from the calculation will be stored as a <code>stochastic</code> property on each point in the data set. The way the values are merged, can be altered using the <code>merge</code> property.</p>
<p>The following is a simple example of the Stochastic oscillator. The %K window has been set to 14 data points.</p>
<pre><code class="lang-js"><span class="hljs-comment">// Create and apply the stochastic oscillator algorithm</span>
<span class="hljs-keyword">var</span> stochasticAlgorithm = fc.indicator.algorithm.stochasticOscillator()
    .kWindowSize(<span class="hljs-number">14</span>);
stochasticAlgorithm(data);

<span class="hljs-comment">// the stochastic oscillator is rendered on its own scale</span>
<span class="hljs-keyword">var</span> yScale = d3.scale.linear()
    ...
    .<span class="hljs-keyword">range</span>([height - <span class="hljs-number">5</span>, <span class="hljs-number">5</span>]);

<span class="hljs-comment">// Create the renderer</span>
<span class="hljs-keyword">var</span> stochastic = fc.indicator.renderer.stochasticOscillator()
    .xScale(xScale)
    .yScale(yScale);

<span class="hljs-comment">// Add it to the container</span>
container.<span class="hljs-built_in">append</span>(<span class="hljs-string">'g'</span>)
    .datum(data)
    .call(stochastic);
</code></pre>
...
<div class="codepen-link">
  <form action="https://codepen.io/pen/define" method="POST" target="_blank">
    <input type="text" name="data" hidden="true"
      value='{
        "html":"&lt;div id&#x3D;\&quot;stochastic\&quot; class&#x3D;\&quot;chart\&quot;&gt;&lt;/div&gt;\n",
...
<div id='stochastic' class='chart'></div>
...
//END
      ...
      <nav class="visible-xs-block">
        <ul class="pager">
            <li class="previous"><a href="/components/indicator/relativeStrengthIndicator.html"><span aria-hidden="true">&larr;</span> Relative Strength Index</a></li>
            <li class="next"><a href="/components/svg/axis.html">Axis <span aria-hidden="true">&rarr;</span></a></li>
        </ul>
      </nav>
    </div>
