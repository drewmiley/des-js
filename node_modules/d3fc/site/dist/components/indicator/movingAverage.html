...
<html lang="en">
  <head>
    ...
    <link rel="canonical" href="https://d3fc.io/components/indicator/movingAverage.html" />
  </head>
  <body>
    <div class="content">
  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-xs-12">
      <h1>
        Moving Average
        <a href="https://github.com/ScottLogic/d3fc/blob/master/src/indicator/algorithm/movingAverage.js">View source on GitHub</a>
      </h1>
      <p>A <a href="http://en.wikipedia.org/wiki/Moving_average">moving average</a> is an indicator that smooths out fluctuations in data. This component computes a <a href="http://en.wikipedia.org/wiki/Moving_average#Simple_moving_average">simple moving average</a> for a given data field, averaging the previous 5 points by default.</p>
<p>D3FC indicators are comprised of two component parts:</p>
<ul>
<li>The indicator algorithm, which is applied to the input data. The algorithm computes the indicator and merges the result back into the source data (although this behaviour is configurable).</li>
<li>An optional indicator renderer, that converts the algorithm output into one or more series / annotations.</li>
</ul>
<p>Simpler indicators do not require renderer with their output readily rendered via a simple series.</p>
<p>The example below creates a point series and a moving average:</p>
<pre><code class="lang-js"><span class="hljs-comment">// Create and apply the Moving Average</span>
<span class="hljs-keyword">var</span> movingAverage = fc.indicator.algorithm.movingAverage();
movingAverage(data);

<span class="hljs-comment">// Create a line that renders the result</span>
<span class="hljs-keyword">var</span> ma = fc.series.line()
    .yValue(<span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(d)</span> <span class="hljs-comment">{ return d.movingAverage; }</span>)
    .<span class="hljs-title">xScale</span><span class="hljs-params">(xScale)</span>
    .<span class="hljs-title">yScale</span><span class="hljs-params">(yScale)</span>;</span>
</code></pre>
<div class="codepen-link">
  <form action="https://codepen.io/pen/define" method="POST" target="_blank">
    <input type="text" name="data" hidden="true"
      value='{
        "html":"&lt;div id&#x3D;\&quot;ma\&quot; class&#x3D;\&quot;chart\&quot;&gt;&lt;/div&gt;\n",
...
<p>You can configure the number of datapoints that are included in the moving average via the <code>windowSize</code> property, you can also change the object property that is averaged via the <code>yValue</code> property.</p>

      
      <nav class="visible-xs-block">
        <ul class="pager">
            <li class="previous"><a href="/components/indicator/macd.html"><span aria-hidden="true">&larr;</span> MACD</a></li>
            <li class="next"><a href="/components/indicator/relativeStrengthIndicator.html">Relative Strength Index <span aria-hidden="true">&rarr;</span></a></li>
        </ul>
      </nav>
    </div>
