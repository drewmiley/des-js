...
<html lang="en">
  <head>
    ...
    <link rel="canonical" href="https://d3fc.io/components/indicator/bollingerBands.html" />
  </head>
  <body>
    <div class="content">
  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-xs-12">
      <h1>
        Bollinger Bands
        <a href="https://github.com/ScottLogic/d3fc/blob/master/src/indicator/algorithm/bollingerBands.js">View source on GitHub</a>
      </h1>
      <p><a href="http://en.wikipedia.org/wiki/Bollinger_Bands">Bollinger bands</a> are an indicator that combine an n-point moving average with upper and lower bands that are positioned k-times an n-point standard deviation around the average.</p>
<p>The example below creates a point series and a bollinger band indicator:</p>
<pre><code class="lang-js"><span class="hljs-comment">// Create and apply the bollinger algorithm</span>
var bollingerAlgorithm = fc.indicator.algorithm.bollingerBands()<span class="hljs-comment">;</span>
bollingerAlgorithm(data)<span class="hljs-comment">;</span>
...
container.append(<span class="hljs-string">'g'</span>)
    .datum(data)
    .call(bollinger)<span class="hljs-comment">;</span>
</code></pre>
<div class="codepen-link">
  <form action="https://codepen.io/pen/define" method="POST" target="_blank">
    <input type="text" name="data" hidden="true"
      value='{
        "html":"&lt;div id&#x3D;\&quot;bollinger\&quot; class&#x3D;\&quot;chart\&quot;&gt;&lt;/div&gt;\n",
...
<div id='bollinger' class='chart'></div>
...
//END
      ...
      <nav class="visible-xs-block">
        <ul class="pager">
            <li class="previous"><a href="/components/scale/dateTime.html"><span aria-hidden="true">&larr;</span> Date Time Scale</a></li>
            <li class="next"><a href="/components/indicator/elderRay.html">Elder Ray <span aria-hidden="true">&rarr;</span></a></li>
        </ul>
      </nav>
    </div>
