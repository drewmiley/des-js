...
<html lang="en">
  <head>
    ...
    <link rel="canonical" href="https://d3fc.io/components/annotation/gridlines.html" />
  </head>
  <body>
    <div class="content">
  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-xs-12">
      ...
      <p>This component renders horizontal and vertical gridlines based on the ticks supplied by the associated axes.</p>
<p>The following is a simple example:</p>
<pre><code class="lang-js"><span class="hljs-keyword">var</span> xScale = d3.scale.linear()
    .domain([<span class="hljs-number">0</span>, <span class="hljs-number">50</span>])
    .<span class="hljs-keyword">range</span>([<span class="hljs-number">0</span>, width]);
...
<div class="codepen-link">
  <form action="https://codepen.io/pen/define" method="POST" target="_blank">
    <input type="text" name="data" hidden="true"
      value='{
        "html":"&lt;div id&#x3D;\&quot;gridlines\&quot; class&#x3D;\&quot;chart\&quot;&gt;&lt;/div&gt;\n",
...
<div id='gridlines' class='chart'></div>
...
<p>You can configure the number of ticks via the <code>xTicks</code> and <code>yTicks</code> properties.</p>
      ...
      <nav class="visible-xs-block">
        <ul class="pager">
            <li class="previous"><a href="/components/annotation/band.html"><span aria-hidden="true">&larr;</span> Band</a></li>
            <li class="next"><a href="/components/annotation/line.html">Line <span aria-hidden="true">&rarr;</span></a></li>
        </ul>
      </nav>
    </div>
