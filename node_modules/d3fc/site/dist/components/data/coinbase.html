...
<html lang="en">
  <head>
    ...
    <link rel="canonical" href="https://d3fc.io/components/data/coinbase.html" />
  </head>
  <body>
    <div class="content">
...
<pre><code class="lang-js"><span class="hljs-symbol">var</span> feed = fc<span class="hljs-meta">.data</span>.feed.coinbase()<span class="hljs-comment">;</span>

// fetch some <span class="hljs-meta">data</span>!
<span class="hljs-symbol">feed</span>(<span class="hljs-meta">function</span>(error, <span class="hljs-meta">data</span>) {
    <span class="hljs-built_in">d3</span>.<span class="hljs-keyword">select('#coinbase')
</span>      <span class="hljs-meta">.text</span>(JSON.<span class="hljs-keyword">stringify(error </span>? error : <span class="hljs-meta">data</span>, null, <span class="hljs-number">2</span>))<span class="hljs-comment">;</span>
...
feed(function(error, data) {
    d3.select('#coinbase')
      ...
      <nav class="visible-xs-block">
        <ul class="pager">
            <li class="previous"><a href="/components/layout/rectangles.html"><span aria-hidden="true">&larr;</span> Rectangles</a></li>
            <li class="next"><a href="/components/data/financial.html">Random Financial <span aria-hidden="true">&rarr;</span></a></li>
        </ul>
      </nav>
    </div>
