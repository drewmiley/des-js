...
<html lang="en">
  <head>
    ...
    <link rel="canonical" href="https://d3fc.io/components/data/financial.html" />
  </head>
  <body>
    <div class="content">
  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-xs-12">
      ...
      <p>The random financial data generator component is a useful testing utility that generates data via a random walk algorithm.</p>
<p>The following example:</p>
<pre><code class="lang-js"><span class="hljs-title">var</span> dataGenerator = fc.<span class="hljs-class"><span class="hljs-keyword">data</span>.random.financial();</span>

// generate some <span class="hljs-class"><span class="hljs-keyword">data</span>!</span>
<span class="hljs-title">var</span> <span class="hljs-class"><span class="hljs-keyword">data</span> = dataGenerator(5);</span>

<span class="hljs-title">d3</span>.select('#financial')
...
<div class="codepen-link">
  <form action="https://codepen.io/pen/define" method="POST" target="_blank">
    <input type="text" name="data" hidden="true"
      value='{
        "html":"&lt;pre id&#x3D;\&quot;financial\&quot;&gt;&lt;/pre&gt;\n",
        "js": "var dataGenerator = fc.data.random.financial();\n\n// generate some data!\nvar data = dataGenerator(5);\n\nd3.select(\"#financial\")\n  .text(JSON.stringify(data, null, 2));\n",
        "css": "",
...
<p>A <code>filter</code> can be supplied to skips other days, or change the start price, volume and date. Pre-defined filters can be used, for example to skip weekends use <code>fc.data.random.filter.skipWeekends</code>.</p>

      
      <nav class="visible-xs-block">
        <ul class="pager">
            <li class="previous"><a href="/components/data/coinbase.html"><span aria-hidden="true">&larr;</span> Coinbase</a></li>
            <li class="next"><a href="/components/data/quandl.html">Quandl <span aria-hidden="true">&rarr;</span></a></li>
        </ul>
      </nav>
    </div>
