...
<html lang="en">
  <head>
    ...
    <link rel="canonical" href="https://d3fc.io/components/data/walk.html" />
  </head>
  <body>
    <div class="content">
  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-xs-12">
      <h1>
        Random Walk
        <a href="https://github.com/ScottLogic/d3fc/blob/master/src/data/random/walk.js">View source on GitHub</a>
      </h1>
      <p>The random walk component creates a random series of values based on a <a href="http://stuartreid.co.za/interactive-stochastic-processes/">Geometric Brownian Motion</a>. It
is useful for generating arbitrary sets of data. The <a href="./financial.html">random financial</a> component uses this component to create a random price series and a random volume series.</p>
<pre><code class="lang-js"><span class="hljs-title">var</span> dataGenerator = fc.<span class="hljs-class"><span class="hljs-keyword">data</span>.random.walk()</span>
  .period(<span class="hljs-number">2</span>)   // <span class="hljs-type">Projection</span> period, by <span class="hljs-keyword">default</span> = 1
  .steps(<span class="hljs-number">30</span>)   // <span class="hljs-type">Number</span> <span class="hljs-keyword">of</span> points to generate, by <span class="hljs-keyword">default</span> = 20
  .mu(<span class="hljs-number">0.3</span>)     // <span class="hljs-type">Drift</span> component, by <span class="hljs-keyword">default</span> = 0.1
  .sigma(<span class="hljs-number">0.2</span>); // <span class="hljs-type">Volatility</span>, by <span class="hljs-keyword">default</span> = 0.1

// <span class="hljs-class"><span class="hljs-keyword">data</span> is generated here</span>
<span class="hljs-title">var</span> <span class="hljs-class"><span class="hljs-keyword">data</span> = dataGenerator(100); // <span class="hljs-type">The</span> series starts at 100</span>

<span class="hljs-title">d3</span>.select('#walk')
  .text(<span class="hljs-type">JSON</span>.stringify(<span class="hljs-class"><span class="hljs-keyword">data</span>, null, 2));</span>
</code></pre>
<p>The data generated is returned as a simple numeric array.</p>
<div class="codepen-link">
  <form action="https://codepen.io/pen/define" method="POST" target="_blank">
    <input type="text" name="data" hidden="true"
      value='{
        "html":"&lt;pre id&#x3D;\&quot;walk\&quot;&gt;&lt;/pre&gt;\n",
        "js": "var dataGenerator = fc.data.random.walk()\n  .period(2)   // Projection period, by default = 1\n  .steps(30)   // Number of points to generate, by default = 20\n  .mu(0.3)     // Drift component, by default = 0.1\n  .sigma(0.2); // Volatility, by default = 0.1\n\n// data is generated here\nvar data = dataGenerator(100); // The series starts at 100\n\nd3.select(\"#walk\")\n  .text(JSON.stringify(data, null, 2));\n",
        "css": "",
...
d3.select('#walk')
  .text(JSON.stringify(data, null, 2));
      ...
      <nav class="visible-xs-block">
        <ul class="pager">
            <li class="previous"><a href="/components/data/spread.html"><span aria-hidden="true">&larr;</span> Spread</a></li>
            <li class="next"><a href="/components/scale/dateTime.html">Date Time Scale <span aria-hidden="true">&rarr;</span></a></li>
        </ul>
      </nav>
    </div>
