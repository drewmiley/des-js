...
<html lang="en">
  <head>
    ...
    <link rel="canonical" href="https://d3fc.io/components/data/quandl.html" />
  </head>
  <body>
    <div class="content">
...
<pre><code class="lang-js"><span class="hljs-built_in">var</span> feed = fc.<span class="hljs-built_in">data</span>.feed.quandl()
  .database(<span class="hljs-string">'WIKI'</span>)
  .dataset(<span class="hljs-string">'AAPL'</span>)
  .<span class="hljs-keyword">rows</span>(<span class="hljs-number">10</span>)
  .<span class="hljs-keyword">descending</span>(<span class="hljs-literal">true</span>)
  .collapse(<span class="hljs-string">'weekly'</span>);

<span class="hljs-comment">// fetch some data!</span>
feed(function(error, <span class="hljs-built_in">data</span>) {
    d3.<span class="hljs-keyword">select</span>(<span class="hljs-string">'#quandl'</span>)
      .text(JSON.stringify(error ? error : <span class="hljs-built_in">data</span>, <span class="hljs-built_in">null</span>, <span class="hljs-number">2</span>));
});
</code></pre>
...
feed(function(error, data) {
    d3.select('#quandl')
      ...
      <nav class="visible-xs-block">
        <ul class="pager">
            <li class="previous"><a href="/components/data/financial.html"><span aria-hidden="true">&larr;</span> Random Financial</a></li>
            <li class="next"><a href="/components/data/spread.html">Spread <span aria-hidden="true">&rarr;</span></a></li>
        </ul>
      </nav>
    </div>
