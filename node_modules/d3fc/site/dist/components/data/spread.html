...
<html lang="en">
  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-xs-12">
      <h1>
        Spread
        <a href="https://github.com/ScottLogic/d3fc/blob/master/src/data/spread.js">View source on GitHub</a>
      </h1>
...
d3.select('#spread-horizontal')
    .text(JSON.stringify(series,  null, 2));
      ...
      <nav class="visible-xs-block">
        <ul class="pager">
            <li class="previous"><a href="/components/data/quandl.html"><span aria-hidden="true">&larr;</span> Quandl</a></li>
